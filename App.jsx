          ...
          <thead>
            <tr style={{ background:"#F8FAFC" }}>
              ...
              {DAYS.map((day,di) => {
                ...
                const diff = di - nowDay;
                const d = new Date(now);
                d.setDate(now.getDate() + diff);
                const dateStr = d.getDate() + "/" + (d.getMonth()+1);
                return (
                  <th key={day} style={{ padding:"8px 8px", textAlign:"center", fontWeight:700,
                    color: di===today ? "#2563EB" : "#0F2744",
                    borderBottom:"2px solid #E2E8F0", background: di===today ? "#EFF6FF" : "transparent", minWidth:110 }}>
                    <div>{day.slice(0,3)}</div>
                    <div style={{ fontSize:11, color: di===today?"#2563EB":"#94A3B8", fontWeight:600, marginTop:2 }}>{dateStr}</div>
                    {di===today && <div style={{ fontSize:10, color:"#2563EB", fontWeight:700 }}>TODAY</div>}
                  </th>
                );
              })}
        ...
        <div style={{ maxWidth:1400, margin:"0 auto", padding:"0 16px" }}>
          <div style={{ display:"flex", alignItems:"center", gap:6, padding:"10px 0", overflowX:"auto" }}>
            ...
            <div style={{ marginLeft:"auto", display:"flex", alignItems:"center", gap:8, flexShrink:0 }}>
              {/* Auto-save indicator */}
              <div style={{ display:"flex", alignItems:"center", gap:4, background:"rgba(16,185,129,0.15)",
                border:"1px solid rgba(16,185,129,0.3)", borderRadius:20, padding:"4px 10px" }}>
                <div style={{ width:6, height:6, borderRadius:"50%", background:"#10B981" }}/>
                <span style={{ fontSize:10, color:"#10B981", fontWeight:700 }}>Auto-saved</span>
              </div>
              ...
              {/* Data History — only Team Lead, Shift Leader, Mohammed Nasser Althurwi */}
